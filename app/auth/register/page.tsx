      ...
      <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-outfit font-bold text-foreground">Request Access</h2>
            <p className="mt-2 text-muted-foreground">Get started with your school management system</p>
          </div>
